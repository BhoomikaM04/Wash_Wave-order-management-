...
if (isset($_GET['action']) && $_GET['action'] == 'confirm_received' && isset($_GET['order_id'])) {
    ...
    if ($stmt->execute()) {
        header("Location: admin-orders-pending.php?success=Payment marked as Paid in database!");
        exit();
    }
}
?>
...
<head>
    ...
    <title>Pending Orders Panel - WashWave</title>
...
<div class="container-fluid px-4 py-5">
    <div class="card border-0 shadow-sm p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold text-dark m-0"><i class="fas fa-hourglass-half me-2 text-warning"></i> WashWave Pending Orders Registry</h4>
                ...
                <tbody>
                    ...
                    if ($result && $result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            $laundry_status = ($db_status === 'Paid') ? 'Pending' : $db_status;
                            ?>
                            <tr>
                                ...
                                <td>
                                    <form action="admin-orders-pending.php" method="POST" class="d-flex gap-1 align-items-center">
                                ...
                                <td class="text-center">
                                    ...
                                    <?php else: ?>
                                        <a href="admin-orders-pending.php?action=confirm_received&order_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success fw-bold py-1 px-2" style="font-size:12px;">Confirm Cash Received</a>
                                    <?php endif; ?>
                                </td>
                                <td>
                        ...
                        echo "<tr><td colspan='11' class='text-center py-4 text-muted'>No pending transaction entries recorded.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
